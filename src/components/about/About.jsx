            ...
            <div className="hero-content flex-col lg:flex-row gap-20">
              ...
              >
                <p className="text-[16px] 2xl:text-lg indent-10 text-justify text-[#67738e]">
                  ...
                  toolkit to tackle challenges in the field.
                </p>
                <br />
                <p className="text-[16px] 2xl:text-lg indent-10 text-justify text-[#67738e]">
                  Driven by curiosity and a hunger for I am enthusiastic about
                  applying my knowledge to real-world projects and collaborating
                  with experienced professionals. My goal is not only to enhance
                  my technical proficiency but also to make a tangible impact
                  within the organization. leveraging creativity and
                  problem-solving skills to deliver innovative solutions.
                </p>
              </div>
            </div>
          </div>
