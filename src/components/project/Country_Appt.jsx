      ...
      <section className=" flex justify-center  mt-20  mx-auto  max-xl:hidden  gap-20   px-44 scroll-smooth">
        <section className="flex justify-center items-center ">
          ...
          >
            ...
            <section className="w-[600px] h-[140px] bg-[#112240] mt-5 p-5 absolute left-0 font-Mono  text-orange-200 text-justify text-[15px] font-bold">
              <p>
...
export default CountryAppProject;
